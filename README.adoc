...
Wir haben uns dazu entschieden eine klassische Schichtarchitektur zu implementiern.
Diese besteht aus einer GUI-Schicht, einer Geschäftslogikschicht und einer Persistenzschicht.
Die Architektur wird konkreter in der Klasse "ArchitectureRulesTest" beschreiben.
