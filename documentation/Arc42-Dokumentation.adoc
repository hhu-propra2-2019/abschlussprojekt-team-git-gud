...
image::/Kontextausschnitt.png[optional alt text]
...
image::https://github.com/hhu-propra2/abschlussprojekt-team-git-gud/blob/documentation_change/documentation/tech_kontext_ausschnitt.png[optional alt text]
