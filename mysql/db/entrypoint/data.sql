...
CREATE TABLE `datei` (
  ...
  CONSTRAINT `datei_ibfk_1` FOREIGN KEY (`uploader_userid`) REFERENCES `userDAO` (`userid`),
  CONSTRAINT `datei_ibfk_2` FOREIGN KEY (`gruppe_gruppeid`) REFERENCES `gruppeDAO` (`gruppeid`)
...
DROP TABLE IF EXISTS `gruppeDAO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gruppeDAO` (
...
CREATE TABLE `gruppenbelegung` (
  ...
  KEY `userID` (`userid`),
  CONSTRAINT `gruppenbelegung_ibfk_1` FOREIGN KEY (`gruppeid`) REFERENCES `gruppeDAO` (`gruppeid`),
  CONSTRAINT `gruppenbelegung_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `userDAO` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
